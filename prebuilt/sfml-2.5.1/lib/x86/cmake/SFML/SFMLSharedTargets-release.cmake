...
set_target_properties(sfml-system PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-system.so"
  IMPORTED_SONAME_RELEASE "libsfml-system.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-system )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-system "${_IMPORT_PREFIX}/lib/x86/libsfml-system.so" )
...
set_target_properties(sfml-main PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-main.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-main )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-main "${_IMPORT_PREFIX}/lib/x86/libsfml-main.a" )
...
set_target_properties(sfml-activity PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-activity.so"
  IMPORTED_SONAME_RELEASE "libsfml-activity.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-activity )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-activity "${_IMPORT_PREFIX}/lib/x86/libsfml-activity.so" )

# Import target "sfml-window" for configuration "Release"
set_property(TARGET sfml-window APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(sfml-window PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-window.so"
  IMPORTED_SONAME_RELEASE "libsfml-window.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-window )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-window "${_IMPORT_PREFIX}/lib/x86/libsfml-window.so" )
...
set_target_properties(sfml-network PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-network.so"
  IMPORTED_SONAME_RELEASE "libsfml-network.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-network )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-network "${_IMPORT_PREFIX}/lib/x86/libsfml-network.so" )
...
set_target_properties(sfml-graphics PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-graphics.so"
  IMPORTED_SONAME_RELEASE "libsfml-graphics.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-graphics )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-graphics "${_IMPORT_PREFIX}/lib/x86/libsfml-graphics.so" )
...
set_target_properties(sfml-audio PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86/libsfml-audio.so"
  IMPORTED_SONAME_RELEASE "libsfml-audio.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS sfml-audio )
list(APPEND _IMPORT_CHECK_FILES_FOR_sfml-audio "${_IMPORT_PREFIX}/lib/x86/libsfml-audio.so" )
